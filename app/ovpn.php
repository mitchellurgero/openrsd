...
class openvpn
{
    ...
    public $srvConfigPath; //May be removed since the calling functions need to specify path during ovpnWriteConfig($path); function
    public $proto;
    public $port;
    public $dev;
    public $ca;
    ...
    public $dh;
    public $server;
    public $ifconfig_pool_persist;
    public $server_bridge;
    public $push_routes;
    public $push_gateway = "redirect-gateway";
    public $push_dns;
    public $client_to_client = "client-to-client";
    public $keepalive = "10 120";
    public $maxclients = "100";
    public $compression = "comp-lzo";
    public $log = "openvpn.log";
    public $verb = "3";
